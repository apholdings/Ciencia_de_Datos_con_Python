...
La ingeniería de características es un aspecto esencial del aprendizaje automático y la ciencia de datos que a menudo se pasa por alto. Se trata de crear nuevas características a partir de las ya existentes para mejorar la eficacia de los modelos de aprendizaje automático. Aquí hay una breve introducción a este tema.
